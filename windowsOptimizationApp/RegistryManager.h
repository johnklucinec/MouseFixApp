...
public:
    explicit RegistryManager(
        HKEY rootKey = HKEY_CURRENT_USER); // Constructor with default root key
    void createKey(const std::string& path);
    void createVec(const std::string& path, const std::vector<BYTE>& data,
        const std::string& valName = "");
    void deleteVal(const std::string& path, const std::string& valName);
    void deleteKey(const std::string& path);

    template <typename T>
    void createVal(const std::string& path, const T data,
        const std::string& valName = "");
...
template <typename T>
void RegistryManager::createVal(const std::string& path, const T data,
    const std::string& valName)
{
    HKEY hkey;
