...
static const std::vector<BYTE> yData = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
void MouseScaleFix::setScale100() {
    ...
    // Curve data
    const std::vector<BYTE> xData = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
void MouseScaleFix::setScale350() {
    ...
    const std::vector<BYTE> xData = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                      0xC0, 0xCC, 0x2C, 0x00, 0x00, 0x00, 0x00, 0x00,
                                      0x80, 0x99, 0x59, 0x00, 0x00, 0x00, 0x00, 0x00,
                                      0x40, 0x66, 0x86, 0x00, 0x00, 0x00, 0x00, 0x00,
                                      0x00, 0x33, 0xB3, 0x00, 0x00, 0x00, 0x00, 0x00 };
...
void MouseScaleFix::setScaleDefault() {
	...
	const std::vector<BYTE> yData = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
void MouseScaleFix::applyMarkC(const std::vector<BYTE>& xData, const std::vector<BYTE>& yData) {
	...
	regManager.createVal("Control Panel\\Mouse", std::string("10"), "MouseSensitivity");
